...
class Document(models.Model):
    ...
    document_value = models.DecimalField('Document value', db_index=True, max_digits=10, decimal_places=3)
    remark_value = models.DecimalField('Remark value', db_index=True, max_digits=10, decimal_places=3)
    net_value = models.DecimalField('Net value', db_index=True, max_digits=10, decimal_places=3)
    ...
    reimbursement_value = models.DecimalField('Reimbusrsement value', db_index=True, max_digits=10, decimal_places=3)
